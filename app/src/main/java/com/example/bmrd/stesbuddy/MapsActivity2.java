...
public class MapsActivity2 extends FragmentActivity implements OnMapReadyCallback, LocationListener
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFinishBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent mainIntent=new Intent(MapsActivity2.this,REST24Activity.class);
    ...
    public void onLocationChanged(Location location) {
        ...
        if(location==null){
            Toast.makeText(MapsActivity2.this,"Sorry..Location not found",Toast.LENGTH_SHORT).show();
        }
        else {
            ...
            mDatabase=FirebaseDatabase.getInstance().getReference().child("future_rest").child(uid).child("lat").setValue(Lat+"");
            mDatabase=FirebaseDatabase.getInstance().getReference().child("future_rest").child(uid).child("lon").setValue(Lng+"");
...
//            mDatabase.setValue(VolunteersMap);
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Toast.makeText(MapsActivity2.this,"Please turn on location",Toast.LENGTH_LONG).show();
    }

    @Override
    public void onConnectionSuspended(int i) {
        Toast.makeText(MapsActivity2.this,"Please turn on GPS",Toast.LENGTH_LONG).show();
    }
}
