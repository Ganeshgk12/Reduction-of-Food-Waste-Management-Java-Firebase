...
public class MapsActivity4 extends FragmentActivity implements OnMapReadyCallback, LocationListener
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShowNearNGO.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent login_intent=new Intent(MapsActivity4.this,NearNGOActivity.class);
    ...
    public void onLocationChanged(Location location) {
        ...
        if(location==null){
            Toast.makeText(MapsActivity4.this,"Sorry..Location not found",Toast.LENGTH_SHORT).show();
        }
        else {
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Toast.makeText(MapsActivity4.this,"Please turn on location",Toast.LENGTH_LONG).show();
    }

    @Override
    public void onConnectionSuspended(int i) {
        Toast.makeText(MapsActivity4.this,"Please turn on GPS",Toast.LENGTH_LONG).show();
    }
}
