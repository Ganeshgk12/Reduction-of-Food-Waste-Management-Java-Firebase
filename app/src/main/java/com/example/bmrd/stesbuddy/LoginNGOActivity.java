        ...
        mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    Intent i= new Intent(LoginNGOActivity.this,WaitingActivity.class);
                    Bundle bundle=new Bundle();
                    bundle.putString("option","NGO");
                    i.putExtras(bundle);
                    startActivity(i);
                ...
                {
                    mLoginProgress.hide();
                    Toast.makeText(LoginNGOActivity.this,"Oops...error...please try again",Toast.LENGTH_LONG).show();
                }
            }
        });
