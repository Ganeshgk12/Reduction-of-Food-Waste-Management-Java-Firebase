        ...
        mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    Intent i= new Intent(LoginRestActivity.this,WaitingActivity.class);
                    Bundle bundle=new Bundle();
                    bundle.putString("option","Rest");
                    i.putExtras(bundle);
                    startActivity(i);
                ...
                {
                    mLoginProgress.hide();
                    Toast.makeText(LoginRestActivity.this,"Oops...error...please try again",Toast.LENGTH_LONG).show();
                }
            }
        });
