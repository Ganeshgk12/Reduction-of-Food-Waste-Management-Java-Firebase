...
public class OnlyRecommendActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_only_recommend);
        ...
        mNGODatabase= FirebaseDatabase.getInstance().getReference().child("RecommendNGO").child(current_uid);
    ...
    protected void onStart(){
        ...
        FirebaseRecyclerAdapter<NGO, OnlyNearNGOActivity.NGOViewHolder> firebaseRecyclerAdapter=new FirebaseRecyclerAdapter<NGO, OnlyNearNGOActivity.NGOViewHolder>(
                NGO.class,
                R.layout.single_ngo_layout,
                OnlyNearNGOActivity.NGOViewHolder.class,
                mNGODatabase


        ) {
            @Override
            protected void populateViewHolder(final OnlyNearNGOActivity.NGOViewHolder viewHolder, final NGO model, final int position) {

                viewHolder.parent_layout.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Toast.makeText(OnlyRecommendActivity.this,"You clicked on"+viewHolder.getPosition(),Toast.LENGTH_LONG).show();

                        Intent i= new Intent(OnlyRecommendActivity.this,SelectedNGO.class);
