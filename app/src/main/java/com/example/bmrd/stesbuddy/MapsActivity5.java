...
public class MapsActivity5 extends FragmentActivity implements OnMapReadyCallback, LocationListener
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShowNearREST.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent login_intent=new Intent(MapsActivity5.this,NearRESTActivity.class);
    ...
    public void onLocationChanged(Location location) {
        ...
        if(location==null){
            Toast.makeText(MapsActivity5.this,"Sorry..Location not found",Toast.LENGTH_SHORT).show();
        }
        else {
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Toast.makeText(MapsActivity5.this,"Please turn on location",Toast.LENGTH_LONG).show();
    }

    @Override
    public void onConnectionSuspended(int i) {
        Toast.makeText(MapsActivity5.this,"Please turn on GPS",Toast.LENGTH_LONG).show();
    }
}
